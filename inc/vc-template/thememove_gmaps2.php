 ...
 * @var $el_class
 * @var $css
 * @var $this WPBakeryShortCode_Thememove_Gmaps2
 */
$output = '';
					...
					marker: {
						values: [
...

							{
								...
								data: "<?php echo esc_js( $new_marker['info'] );?>",
								options: {
									<?php if (! isset( $new_marker['icon'] ) || $new_marker['icon'] == '') { ?>icon: "<?php echo THEME_ROOT ?>/images/map-marker.png",
